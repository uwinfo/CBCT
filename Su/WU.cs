...
namespace Su
{
    ...
    public partial class Wu
    {
        public static bool IsTestDomain
        {
            get
            {
                return CurrentContext.Current.Request.Host.Host == "localhost"
                    || CurrentContext.Current.Request.Host.Host == "s3admin.bike.idv.tw"
                    || CurrentContext.Current.Request.Host.Host == "shopband-api.bike.idv.tw"
                    || CurrentContext.Current.Request.Host.Host == "shopband.wztech.com.tw"
        ...
        //{
        //    Su.FileLogger.AddOneDayLog(type, message, removeFilesBeforeDays, isThrowExctption, subDirectory: directory);
        //}
        ...
        ///// <summary>
        ///// 會在 LogRoot 之下，自動建立 OneDayLog 的目錄
        ///// </summary>
        //public static void SetLogRoot(string LogRoot)
        //{
        //    _LogRoot = LogRoot;
        //    Su.FileLogger.OneDayLogDirectory = _LogRoot.AddPath("OneDayLog");
        //    System.IO.Directory.CreateDirectory(Su.FileLogger.OneDayLogDirectory);
        //}

        private static string _PrinterUrl = null;
        ...
        /// 印表機網址
        /// </summary>
        public static void SetPrinterUrl(string PrinterUrl)
        {
