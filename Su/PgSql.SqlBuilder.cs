...
//            {
//                And(columnName.PgSqlColumnName() + " =", "N");
//                return this;
//            }
...
//            {
//                this.LtAndCriteria.Add(orList.Select(x => x.Sql).ToOneString(" or "));
//                return this;
//            }

//            public SqlBuilder AndCriteria(string criteria, bool isCheckSql = true)
//            {
...
//                ltRes.Add(SelectFields.PgSqlColumnNameList());

//                ltRes.Add("from");
//                ltRes.Add(TableName.PgSqlTableName());
...
//                    ltRes.Add("order by " +
//                            orderBy.Split(",")
//                            .Select(x => x.Trim().PgSqlColumnName(true))
//                            .ToOneString(", "));
//                }
...
//                return Su.PgSql.DtFromSql(sql, dbId, isCheckDangerSQL: false);
//            }
...
//            public DataRow FirstRow(int id = -1)
//            {
//                if (id > 0)
//                {
//                    this.And("Id = ", id);
...
//                return $"insert into {TableName.PgSqlTableName()}({LtSet.Select(x => x.FieldName.PgSqlColumnName()).ToOneString(", ")}) values({LtSet.Select(x => x.PgSqlValue).ToOneString(", ")})";
//            }
...
//            /// <returns></returns>
//            public long Insert(Sql.DbId dbId = null, int timeout = 0, int? creatorId = null, bool skipCreator = false, bool skipModifier = false)
//            {
//                return ExecuteSql(
...
//            public long Update(Sql.DbId dbId = null, int timeout = 0, int? modifierId = null, bool skipModifier = false)
//            {
...
//                            && ((ex is Npgsql.PostgresException && ((Npgsql.PostgresException)ex).SqlState == "40001")
...
//                                || (ex.InnerException != null && ex.InnerException.InnerException != null && ex.InnerException.InnerException is Npgsql.PostgresException && ((Npgsql.PostgresException)ex.InnerException.InnerException).SqlState == "40001")))
//                        {
//                            //隨機休息 10 ~ 20 ms, 等另一個 job 完工
//                            System.Threading.Thread.Sleep(Su.MathUtil.GetRandomInt(10, 20));
//                            tries++;
//                        }
//                        else
//                        {
...
//                    this.Set("ModifyAt", DateTime.Now);
//                }
...
//                if (IsModifierRequired && !skipModifier && !LtSet.Any(x => x.FieldName == "ModifyAt"))
//                {
//                    throw new Exception("ModifyAt is required.");
//                }

//                List<string> ltRes = new List<string>();
//                ltRes.Add($"update {TableName.PgSqlTableName()} set ");
//                ltRes.Add(LtSet.Select(x => $"{x.FieldName.PgSqlColumnName()} = " + x.PgSqlValue).ToOneString(", "));
//                BuildAndCriteria(ltRes);
...
//            {
//                List<string> ltRes = new List<string>();
//                ltRes.Add($"Delete From {TableName.PgSqlTableName()}");
//                BuildAndCriteria(ltRes);
//                return (int)Su.PgSql.ExecuteSql(ltRes.ToOneString(" "));
//            }
...
//                ltRes.Add($"select count(*) from {TableName.PgSqlTableName()}");
//                BuildAndCriteria(ltRes);
